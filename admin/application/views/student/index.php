				...
				<div class="btn-group" role="toolbar">
						...
						<div class="btn-group" role="toolbar">
								...
								<div class="dropdown-menu">
										...
										<a class="dropdown-item" href="<?=html_escape('assets/files/download/template_murid.xlsx')?>">Download import template</a>
								</div>
						</div>
				</div>
      ...
      <div class="modal-body">
        <form name="form-add" id="form-add" class="d-flex flex-column">
            <div class="row align-items-center">
				...
				<input type="hidden" id="a_sekolah_id" value="<?= $_SESSION['sekolah_id']; ?>" />
			...
			<div class="row align-items-center mt-2">
                ...
                <div class="col-8">
                    <select  class="form-control form-control-sm" name="a_parent_name" multiple></select> 
                </div>
            </div>	
