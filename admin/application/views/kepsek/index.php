		...
		<div class="card">
			...
			<div class="card-body">
						...
						<div class="col">
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text" id="s_teacher_name">Nama Kepala Sekolah</span>
								</div>
								<input type="search" class="form-control" aria-describedby="s_teacher_name" name="s_teacher_name" placeholder="Cari Nama Kepala Sekolah" />
							</div>
						</div>
						<div class="col">
				...
				<div class="btn-group" role="toolbar">
					...
					<div class="btn-group d-none" role="toolbar">
	...
	<div class="modal-dialog">
		<div class="modal-content border-0">
			<div class="modal-header bg-primary">
				<h5 class="modal-title text-capitalize text-light text-shadow">Tambah Kepala Sekolah</h5>
			...
			<div class="modal-body">
				<form name="form-add" id="form-add" class="d-flex flex-column">
					...
					<div class="row align-items-center mt-2">
						...
						<div class="col-8"><input type="number" class="form-control form-control-sm" name="a_nik" /></div>
					</div>
					<div class="row align-items-center mt-2">
						<div class="col-4">
