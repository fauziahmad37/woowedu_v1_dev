...
(async $ => {
    ...
    //     let url = (params.hasOwnProperty('edit') && +params.edit == 1) ? BASE_URL + 'asesmen/edit_soal' : BASE_URL + 'asesmen/save_soal';
