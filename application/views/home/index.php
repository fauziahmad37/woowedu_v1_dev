...
<section class="explore-section section-padding py-3" id="section_2">
	...
	<?php if ($user_level == 3 || $user_level == 4 || $user_level == 5) : ?>
		<div class="row mt-4">
			<div class="col">
				<h4 class="fw-bold"><i class="bi bi-pen-fill me-2"></i> Tugas</h4>
			</div>
		...
		<div class="row mt-4">
			<div class="col">
				<h4 class="fw-bold"><i class="bi bi-clock-fill me-2"></i> Absensi</h4>
			</div>
			<div class="col justify-content-end d-flex align-items-center gap-2">

				<div class="d-flex align-items-end gap-3">
					<!-- start date -->
					<div class="d-flex flex-column">
						<label for="start-date" class="form-label mb-1">Tanggal Awal</label>
						<input type="date" id="start-date" class="form-control form-control-sm" style="max-width: 200px;">
					</div>

					<!-- end date -->
					<div class="d-flex flex-column">
						<label for="end-date" class="form-label mb-1">Tanggal Akhir</label>
						<input type="date" id="end-date" class="form-control form-control-sm" style="max-width: 200px;">
					</div>

					<!-- filter button -->
					<button id="filter-attendance" class="btn btn-primary btn-sm">
						Filter
					</button>
				</div>
		...
		<div class="row mt-3">
			<div class="col">
				<div class="card p-4 rounded-4 border-1 shadow-sm" style="border-color: #F3F4F6;">
					<div class="d-flex align-items-center">
						<span class="rounded-circle" style="background-color: #109BDC; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; margin-right: 10px;">
							<i class="bi bi-watch text-white"></i>
						</span>

						<div>
							<h4 class="fw-semibold mb-0" style="font-size: 20px;">Absensi Terlambat</h4>
							<p class="mb-0" style="color: #7E7E7E;">Total menit absen terlambat kamu</p>
						</div>
					</div>

					<div class="text-center mt-4">
						<h1 class="" style="color: #525252;">120 Menit</h1>
					</div>
			...
			<div class="col">
				<div class="card p-4 rounded-4 border-1 shadow-sm" style="border-color: #F3F4F6;">
					<div class="d-flex align-items-center">
						...
						<div>
							<h4 class="fw-semibold mb-0" style="font-size: 20px;">Pulang Cepat</h4>
							<p class="mb-0" style="color: #7E7E7E;">Total menit pulang lebih cepat kamu</p>
						</div>
					</div>

					<div class="text-center mt-4">
						<h1 class="" style="color: #525252;">50 Menit</h1>
					</div>
		...
		<!-- Pelanggaran -->
		<div class="mt-5">
			<h4 class="fw-bold"><i class="bi bi-exclamation-circle-fill me-2"></i> Pelanggaran</h4>
		</div>

		<div class="d-flex gap-3 overflow-auto pb-3 mt-4">

			<?php
			$data = [
				[
					'jenis' => 'Pelanggaran Ringan',
					'nama' => 'Berbicara Saat Pelajaran',
					'deskripsi' => 'Berbicara saat pelajaran berlangsung sehingga mengganggu konsentrasi teman-teman sekelas.'
				],
				[
					'jenis' => 'Pelanggaran Sedang',
					'nama' => 'Datang Terlambat',
					'deskripsi' => 'Datang terlambat ke sekolah tanpa alasan yang jelas.'
				],
				[
					'jenis' => 'Pelanggaran Berat',
					'nama' => 'Merokok',
					'deskripsi' => 'Tertangkap basah merokok di kamar mandi sekolah pada saat jam istirahat.'
				],
				[
					'jenis' => 'Pelanggaran Ringan',
					'nama' => 'Tidak Mengerjakan PR',
					'deskripsi' => 'Tidak mengerjakan pekerjaan rumah yang diberikan oleh guru tanpa alasan yang jelas.'
				],
				[
					'jenis' => 'Pelanggaran Sedang',
					'nama' => 'Menggunakan Ponsel di Kelas',
					'deskripsi' => 'Menggunakan ponsel selama jam pelajaran sehingga mengganggu proses belajar mengajar.'
				],
				[
					'jenis' => 'Pelanggaran Berat',
					'nama' => 'Bullying',
					'deskripsi' => 'Melakukan tindakan bullying terhadap teman sekelas, baik secara fisik maupun verbal.'
				],
			];
			?>

			<?php foreach ($data as $item) : ?>
				<div class="card p-4 rounded-4 border-1 shadow-sm" style="min-width: 350px; border-color: #F3F4F6;">
					<div class="d-flex align-items-center">
						<span class="rounded-circle" style="background-color: #109BDC; min-width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; margin-right: 10px;">
							<i class="bi bi-exclamation-circle-fill text-white"></i>
						</span>

						<div>
							<h4 class="fw-semibold mb-0" style="font-size: 16px;"><?= $item['jenis'] ?></h4>
							<p class="mb-0" style="color: #7E7E7E;"><?= $item['nama'] ?></p>
						</div>
					</div>
