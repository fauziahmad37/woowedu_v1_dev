...
<script src="<?=html_escape(base_url('assets/libs/pdf.js/generic/build/pdf.js'))?>" type="module"></script>
  ...
  <body tabindex="1">
          ...
          <div class="pos-relative">
            ...
            <div id="sidebarTextTools" class="hidden">
              <div id="editorModeButtons" class="splitToolbarButton toggled" role="radiogroup">
                <!-- HIGHLIGHT -->
                <div class="pos-relative">
                  <button id="editorHighlight" class="toolbarButton" title="Highlight" role="radio" aria-checked="false" aria-controls="editorHighlightParamsToolbar" tabindex="31" data-l10n-id="pdfjs-editor-highlight-button">
                    <span data-l10n-id="pdfjs-editor-highlight-button-label">Highlight</span>
                  </button>
                  <div class="editorParamsSidebar hidden" id="editorHighlightParamsToolbar">
    ...
    <script type="module">
      ...
      const bookUrl = "<?=html_escape(base_url('assets/files/ebooks/'.$book['file_1']))?>";
      AppOption.setDefault('defaultUrl', bookUrl);
