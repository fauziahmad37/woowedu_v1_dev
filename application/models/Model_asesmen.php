...
class Model_asesmen extends CI_Model {
   ...
   /**
    ...
    public function getAllSoal(int $limit = NULL, int $offset = NULL, array $filter = NULL): array {
		$this->db->select('s.*, m.tema_title, m.sub_tema_title');
		...
		if(!empty($filter[5]['search']['value'])){
			$filter[5]['search']['value'] = explode(',', $filter[5]['search']['value']);
     ...
     * @return array
     */
    public function getAllAsesmenKhusus(int $limit = NULL, int $offset = NULL, array $filter = NULL): array {
		...
		if(!empty($filter[2]['search']['value']))
			$this->db->where('e.tipe', $filter[2]['search']['value']);
		...
		if(!empty($filter[6]['search']['value']))
			$this->db->where('e.student_id', (int)$filter[6]['search']['value']);
     ...
     * @return array
     */
	public function getAcountAllAsesmenKhusus(array $filter = NULL): int {
	 ...
	 * @return array
	 */
	public function getStudentCollect(int $limit = NULL, int $offset = NULL, array $filter = NULL): array {
		...
		if(!empty($filter[3]['search']['value']))
			$this->db->where('e.status', $filter[3]['search']['value']);
	 ...
	 * @return array
	 */
	public function getCountStudentCollect(array $filter = NULL): int {
		
		if(!empty($filter['exam_id']))
			$this->db->where('e.exam_id', $filter['exam_id']);
